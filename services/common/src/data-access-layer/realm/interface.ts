...
export interface IRealmRepository {
     ...
     * ```
     */
    create(realmData: DeepPartial<CollectionTypes.Realm>): Promise<CollectionTypes.Realm>;
    /**
     ...
     * ```
     */
    update(realmId: string, updateData: DeepPartial<CollectionTypes.Realm>): Promise<CollectionTypes.Realm>;
}
