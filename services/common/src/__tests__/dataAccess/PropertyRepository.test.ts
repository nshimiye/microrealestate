...
describe('PropertyRepository', () => {
  ...
  describe('Property 1: Plain object returns', () => {
    it('should return plain objects without Mongoose methods for all operations', async () => {
      ...
      await fc.assert(
        fc.asyncProperty(propertyDataArbitrary, async (propertyData) => {
          // Create property
          ...
          // Find all
          const foundAll = await propertyRepository.findAll(
            propertyData.realmId
          );
    ...
    it('should persist realmId so it can be retrieved', async () => {
      ...
      await fc.assert(
        fc.asyncProperty(propertyDataArbitrary, async (propertyData) => {
          ...
          const foundInAll = allProperties.find(
            (p) => p._id.toString() === created._id.toString()
          );
      ...
      await fc.assert(
        fc.asyncProperty(
          ...
          async (propertyData, differentRealmId) => {
            ...
            const deleteCount = await propertyRepository.deleteMany(
              [created._id.toString()],
              differentRealmId
            );
  ...
  describe('create', () => {
    ...
    it('should throw error for missing realmId', async () => {
      ...
      await expect(
        propertyRepository.create(propertyData as any)
      ).rejects.toThrow('Property data must include realmId');
    });
  ...
  describe('update', () => {
    ...
    it('should throw error for invalid property ID', async () => {
      await expect(
        propertyRepository.update('', '507f1f77bcf86cd799439011', {
          name: 'Test'
        })
      ).rejects.toThrow('Property ID must be a non-empty string');

      await expect(
        propertyRepository.update(null as any, '507f1f77bcf86cd799439011', {
          name: 'Test'
        })
      ).rejects.toThrow('Property ID must be a non-empty string');
    });
    ...
    it('should throw error for invalid realm ID', async () => {
      ...
      await expect(
        propertyRepository.update('507f1f77bcf86cd799439011', null as any, {
          name: 'Test'
        })
      ).rejects.toThrow('Realm ID must be a non-empty string');
    });
  ...
  describe('delete', () => {
    it('should delete properties by IDs', async () => {
      ...
      const count = await propertyRepository.deleteMany(
    ...
    it('should throw error for invalid property IDs', async () => {
      await expect(
        propertyRepository.deleteMany([], '507f1f77bcf86cd799439011')
      ).rejects.toThrow('Property IDs must be a non-empty array');

      await expect(
        propertyRepository.deleteMany(null as any, '507f1f77bcf86cd799439011')
      ).rejects.toThrow('Property IDs must be a non-empty array');
    ...
    it('should throw error for invalid realm ID', async () => {
      ...
      await expect(
        propertyRepository.deleteMany(['507f1f77bcf86cd799439011'], null as any)
      ).rejects.toThrow('Realm ID must be a non-empty string');
    });
  });
  ...
  describe('findAll', () => {
    ...
    it('should throw error for invalid realm ID', async () => {
      await expect(propertyRepository.findAll('')).rejects.toThrow(
        'Realm ID must be a non-empty string'
      );

      await expect(propertyRepository.findAll(null as any)).rejects.toThrow(
        'Realm ID must be a non-empty string'
      );
    });
  ...
  describe('countByRealmId', () => {
    it('should count properties in a realm with multiple properties', async () => {
      ...
      const count = await propertyRepository.countByRealmId(
        '507f1f77bcf86cd799439011'
      );
    ...
    it('should throw error for invalid realmId', async () => {
      await expect(propertyRepository.countByRealmId('')).rejects.toThrow(
        'Realm ID must be a non-empty string'
      );
